...
- **Single place to see risk** — Pull a Jira security ticket, extract CVEs from description and attachments, enrich with NVD, and correlate existing **PLAT** Security Vulnerability tickets.
...
Column headers in the CVE findings table (*Affected Image*, *PLAT CVE*) now align precisely with the cell content below them.
